...
func registerSDKWords(r *eng.Registry, client *sdk.DingconnectSDK) {
...
func runOp(client *sdk.DingconnectSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
