...
func TestRegionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set DINGCONNECT_TEST_REGION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func regionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DINGCONNECT_TEST_REGION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DINGCONNECT_TEST_REGION_ENTID"])
