...
const testSeed = `map[string]any{"entity": map[string]any{"account_lookup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "balance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cancel_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "error_code_description": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "estimate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product_description": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "promotion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "promotion_description": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "provider": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "provider_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_transfer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transfer_record": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
