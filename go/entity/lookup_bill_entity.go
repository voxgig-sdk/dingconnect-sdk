...
func NewLookupBillEntity(client *core.DingconnectSDK, entopts map[string]any) *LookupBillEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LookupBillEntity) GetName() string { return e.name }
...
func (e *LookupBillEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LookupBillEntity) Deleted() bool {
	return e.deleted
}


func (e *LookupBillEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLookupBillEntity(e.client, opts)
}

func (e *LookupBillEntity) Data(args ...any) any {
...
func (e *LookupBillEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LookupBill; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LookupBillEntity) DataTyped(data ...LookupBill) LookupBill {
	if len(data) > 0 {
		return typedFrom[LookupBill](e.Data(asMap(data[0])))
	}
	return typedFrom[LookupBill](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LookupBill (all fields
// optional at the wire level).
func (e *LookupBillEntity) MatchTyped(match ...LookupBill) LookupBill {
	if len(match) > 0 {
		return typedFrom[LookupBill](e.Match(asMap(match[0])))
	}
	return typedFrom[LookupBill](e.Match())
}
...
func (e *LookupBillEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LookupBillEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LookupBillEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *LookupBillEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LookupBillCreateData and returns an LookupBill. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LookupBillEntity) CreateTyped(reqdata LookupBillCreateData, ctrl map[string]any) (LookupBill, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return LookupBill{}, err
	}
	return typedFrom[LookupBill](res), nil
}



func (e *LookupBillEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LookupBillEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LookupBillEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
