...
type EstimatePriceEntity struct {
	name    string
...
func NewEstimatePriceEntity(client *core.DingconnectSDK, entopts map[string]any) *EstimatePriceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EstimatePriceEntity) GetName() string { return e.name }
...
func (e *EstimatePriceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EstimatePriceEntity) Deleted() bool {
	return e.deleted
}


func (e *EstimatePriceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEstimatePriceEntity(e.client, opts)
}

func (e *EstimatePriceEntity) Data(args ...any) any {
...
func (e *EstimatePriceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EstimatePrice; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EstimatePriceEntity) DataTyped(data ...EstimatePrice) EstimatePrice {
	if len(data) > 0 {
		return typedFrom[EstimatePrice](e.Data(asMap(data[0])))
	}
	return typedFrom[EstimatePrice](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EstimatePrice (all fields
// optional at the wire level).
func (e *EstimatePriceEntity) MatchTyped(match ...EstimatePrice) EstimatePrice {
	if len(match) > 0 {
		return typedFrom[EstimatePrice](e.Match(asMap(match[0])))
	}
	return typedFrom[EstimatePrice](e.Match())
}
...
func (e *EstimatePriceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EstimatePriceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EstimatePriceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EstimatePriceEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EstimatePriceCreateData and returns an EstimatePrice. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EstimatePriceEntity) CreateTyped(reqdata EstimatePriceCreateData, ctrl map[string]any) (EstimatePrice, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EstimatePrice{}, err
	}
	return typedFrom[EstimatePrice](res), nil
}



func (e *EstimatePriceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EstimatePriceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EstimatePriceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
