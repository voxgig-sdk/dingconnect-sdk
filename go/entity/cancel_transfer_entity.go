...
type CancelTransferEntity struct {
	name    string
...
func NewCancelTransferEntity(client *core.DingconnectSDK, entopts map[string]any) *CancelTransferEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CancelTransferEntity) GetName() string { return e.name }
...
func (e *CancelTransferEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CancelTransferEntity) Deleted() bool {
	return e.deleted
}


func (e *CancelTransferEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCancelTransferEntity(e.client, opts)
}

func (e *CancelTransferEntity) Data(args ...any) any {
...
func (e *CancelTransferEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CancelTransfer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CancelTransferEntity) DataTyped(data ...CancelTransfer) CancelTransfer {
	if len(data) > 0 {
		return typedFrom[CancelTransfer](e.Data(asMap(data[0])))
	}
	return typedFrom[CancelTransfer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CancelTransfer (all fields
// optional at the wire level).
func (e *CancelTransferEntity) MatchTyped(match ...CancelTransfer) CancelTransfer {
	if len(match) > 0 {
		return typedFrom[CancelTransfer](e.Match(asMap(match[0])))
	}
	return typedFrom[CancelTransfer](e.Match())
}
...
func (e *CancelTransferEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CancelTransferEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CancelTransferEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CancelTransferEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CancelTransferCreateData and returns an CancelTransfer. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CancelTransferEntity) CreateTyped(reqdata CancelTransferCreateData, ctrl map[string]any) (CancelTransfer, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CancelTransfer{}, err
	}
	return typedFrom[CancelTransfer](res), nil
}



func (e *CancelTransferEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CancelTransferEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CancelTransferEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
