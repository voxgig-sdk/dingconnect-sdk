...
func NewPromotionEntity(client *core.DingconnectSDK, entopts map[string]any) *PromotionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PromotionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PromotionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PromotionListMatch and returns []Promotion. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PromotionEntity) ListTyped(reqmatch PromotionListMatch, ctrl map[string]any) ([]Promotion, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Promotion](res), nil
}
