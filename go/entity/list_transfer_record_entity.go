...
type ListTransferRecordEntity struct {
	name    string
...
func NewListTransferRecordEntity(client *core.DingconnectSDK, entopts map[string]any) *ListTransferRecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListTransferRecordEntity) GetName() string { return e.name }
...
func (e *ListTransferRecordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListTransferRecordEntity) Deleted() bool {
	return e.deleted
}


func (e *ListTransferRecordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListTransferRecordEntity(e.client, opts)
}

func (e *ListTransferRecordEntity) Data(args ...any) any {
...
func (e *ListTransferRecordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListTransferRecord; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListTransferRecordEntity) DataTyped(data ...ListTransferRecord) ListTransferRecord {
	if len(data) > 0 {
		return typedFrom[ListTransferRecord](e.Data(asMap(data[0])))
	}
	return typedFrom[ListTransferRecord](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListTransferRecord (all fields
// optional at the wire level).
func (e *ListTransferRecordEntity) MatchTyped(match ...ListTransferRecord) ListTransferRecord {
	if len(match) > 0 {
		return typedFrom[ListTransferRecord](e.Match(asMap(match[0])))
	}
	return typedFrom[ListTransferRecord](e.Match())
}
...
func (e *ListTransferRecordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListTransferRecordEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ListTransferRecordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ListTransferRecordEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListTransferRecordCreateData and returns an ListTransferRecord. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ListTransferRecordEntity) CreateTyped(reqdata ListTransferRecordCreateData, ctrl map[string]any) (ListTransferRecord, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ListTransferRecord{}, err
	}
	return typedFrom[ListTransferRecord](res), nil
}



func (e *ListTransferRecordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListTransferRecordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListTransferRecordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
