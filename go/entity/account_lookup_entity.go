...
type AccountLookupEntity struct {
	name    string
...
func NewAccountLookupEntity(client *core.DingconnectSDK, entopts map[string]any) *AccountLookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AccountLookupEntity) GetName() string { return e.name }
...
func (e *AccountLookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AccountLookupEntity) Deleted() bool {
	return e.deleted
}


func (e *AccountLookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAccountLookupEntity(e.client, opts)
}

func (e *AccountLookupEntity) Data(args ...any) any {
...
func (e *AccountLookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AccountLookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AccountLookupEntity) DataTyped(data ...AccountLookup) AccountLookup {
	if len(data) > 0 {
		return typedFrom[AccountLookup](e.Data(asMap(data[0])))
	}
	return typedFrom[AccountLookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AccountLookup (all fields
// optional at the wire level).
func (e *AccountLookupEntity) MatchTyped(match ...AccountLookup) AccountLookup {
	if len(match) > 0 {
		return typedFrom[AccountLookup](e.Match(asMap(match[0])))
	}
	return typedFrom[AccountLookup](e.Match())
}
...
func (e *AccountLookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AccountLookupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AccountLookupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AccountLookupListMatch and returns []AccountLookup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AccountLookupEntity) ListTyped(reqmatch AccountLookupListMatch, ctrl map[string]any) ([]AccountLookup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AccountLookup](res), nil
}



func (e *AccountLookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AccountLookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AccountLookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AccountLookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
