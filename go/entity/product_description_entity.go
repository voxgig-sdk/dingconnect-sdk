...
type ProductDescriptionEntity struct {
	name    string
...
func NewProductDescriptionEntity(client *core.DingconnectSDK, entopts map[string]any) *ProductDescriptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProductDescriptionEntity) GetName() string { return e.name }
...
func (e *ProductDescriptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProductDescriptionEntity) Deleted() bool {
	return e.deleted
}


func (e *ProductDescriptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProductDescriptionEntity(e.client, opts)
}

func (e *ProductDescriptionEntity) Data(args ...any) any {
...
func (e *ProductDescriptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProductDescription; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProductDescriptionEntity) DataTyped(data ...ProductDescription) ProductDescription {
	if len(data) > 0 {
		return typedFrom[ProductDescription](e.Data(asMap(data[0])))
	}
	return typedFrom[ProductDescription](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProductDescription (all fields
// optional at the wire level).
func (e *ProductDescriptionEntity) MatchTyped(match ...ProductDescription) ProductDescription {
	if len(match) > 0 {
		return typedFrom[ProductDescription](e.Match(asMap(match[0])))
	}
	return typedFrom[ProductDescription](e.Match())
}
...
func (e *ProductDescriptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProductDescriptionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProductDescriptionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProductDescriptionListMatch and returns []ProductDescription. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProductDescriptionEntity) ListTyped(reqmatch ProductDescriptionListMatch, ctrl map[string]any) ([]ProductDescription, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProductDescription](res), nil
}



func (e *ProductDescriptionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProductDescriptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProductDescriptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProductDescriptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
