...
type ErrorCodeDescriptionEntity struct {
	name    string
...
func NewErrorCodeDescriptionEntity(client *core.DingconnectSDK, entopts map[string]any) *ErrorCodeDescriptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ErrorCodeDescriptionEntity) GetName() string { return e.name }
...
func (e *ErrorCodeDescriptionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ErrorCodeDescriptionEntity) Deleted() bool {
	return e.deleted
}


func (e *ErrorCodeDescriptionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewErrorCodeDescriptionEntity(e.client, opts)
}

func (e *ErrorCodeDescriptionEntity) Data(args ...any) any {
...
func (e *ErrorCodeDescriptionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ErrorCodeDescription; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ErrorCodeDescriptionEntity) DataTyped(data ...ErrorCodeDescription) ErrorCodeDescription {
	if len(data) > 0 {
		return typedFrom[ErrorCodeDescription](e.Data(asMap(data[0])))
	}
	return typedFrom[ErrorCodeDescription](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ErrorCodeDescription (all fields
// optional at the wire level).
func (e *ErrorCodeDescriptionEntity) MatchTyped(match ...ErrorCodeDescription) ErrorCodeDescription {
	if len(match) > 0 {
		return typedFrom[ErrorCodeDescription](e.Match(asMap(match[0])))
	}
	return typedFrom[ErrorCodeDescription](e.Match())
}
...
func (e *ErrorCodeDescriptionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ErrorCodeDescriptionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ErrorCodeDescriptionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ErrorCodeDescriptionListMatch and returns []ErrorCodeDescription. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ErrorCodeDescriptionEntity) ListTyped(reqmatch ErrorCodeDescriptionListMatch, ctrl map[string]any) ([]ErrorCodeDescription, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ErrorCodeDescription](res), nil
}



func (e *ErrorCodeDescriptionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ErrorCodeDescriptionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ErrorCodeDescriptionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ErrorCodeDescriptionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
