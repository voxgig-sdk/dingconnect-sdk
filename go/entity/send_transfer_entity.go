...
type SendTransferEntity struct {
	name    string
...
func NewSendTransferEntity(client *core.DingconnectSDK, entopts map[string]any) *SendTransferEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SendTransferEntity) GetName() string { return e.name }
...
func (e *SendTransferEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SendTransferEntity) Deleted() bool {
	return e.deleted
}


func (e *SendTransferEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSendTransferEntity(e.client, opts)
}

func (e *SendTransferEntity) Data(args ...any) any {
...
func (e *SendTransferEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SendTransfer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SendTransferEntity) DataTyped(data ...SendTransfer) SendTransfer {
	if len(data) > 0 {
		return typedFrom[SendTransfer](e.Data(asMap(data[0])))
	}
	return typedFrom[SendTransfer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SendTransfer (all fields
// optional at the wire level).
func (e *SendTransferEntity) MatchTyped(match ...SendTransfer) SendTransfer {
	if len(match) > 0 {
		return typedFrom[SendTransfer](e.Match(asMap(match[0])))
	}
	return typedFrom[SendTransfer](e.Match())
}
...
func (e *SendTransferEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SendTransferEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SendTransferEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SendTransferEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SendTransferCreateData and returns an SendTransfer. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SendTransferEntity) CreateTyped(reqdata SendTransferCreateData, ctrl map[string]any) (SendTransfer, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SendTransfer{}, err
	}
	return typedFrom[SendTransfer](res), nil
}



func (e *SendTransferEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SendTransferEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SendTransferEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
