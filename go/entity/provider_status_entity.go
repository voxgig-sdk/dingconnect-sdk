...
type ProviderStatusEntity struct {
	name    string
...
func NewProviderStatusEntity(client *core.DingconnectSDK, entopts map[string]any) *ProviderStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProviderStatusEntity) GetName() string { return e.name }
...
func (e *ProviderStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProviderStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ProviderStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProviderStatusEntity(e.client, opts)
}

func (e *ProviderStatusEntity) Data(args ...any) any {
...
func (e *ProviderStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProviderStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProviderStatusEntity) DataTyped(data ...ProviderStatus) ProviderStatus {
	if len(data) > 0 {
		return typedFrom[ProviderStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ProviderStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProviderStatus (all fields
// optional at the wire level).
func (e *ProviderStatusEntity) MatchTyped(match ...ProviderStatus) ProviderStatus {
	if len(match) > 0 {
		return typedFrom[ProviderStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ProviderStatus](e.Match())
}
...
func (e *ProviderStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProviderStatusEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProviderStatusEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProviderStatusListMatch and returns []ProviderStatus. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProviderStatusEntity) ListTyped(reqmatch ProviderStatusListMatch, ctrl map[string]any) ([]ProviderStatus, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProviderStatus](res), nil
}



func (e *ProviderStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProviderStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProviderStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProviderStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
