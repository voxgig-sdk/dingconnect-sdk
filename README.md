...
Ding API client, generated from the OpenAPI spec.

The Ding API is a Level 0 REST web service.

Learn more about Ding API at [dingconnect.com](https://dingconnect.com).

This is an unofficial SDK for the Ding public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| **AccountLookup** | The AccountLookup entity (list). | `/api/V1/GetAccountLookup` |
| **Balance** | The Balance entity (list). | `/api/V1/GetBalance` |
| **CancelTransfer** | The CancelTransfer entity (create). | `/api/V1/CancelTransfers` |
| **Country** | The Country entity (list). | `/api/V1/GetCountries` |
| **Currency** | The Currency entity (list). | `/api/V1/GetCurrencies` |
| **ErrorCodeDescription** | The ErrorCodeDescription entity (list). | `/api/V1/GetErrorCodeDescriptions` |
| **EstimatePrice** | The EstimatePrice entity (create). | `/api/V1/EstimatePrices` |
| **ListTransferRecord** | The ListTransferRecord entity (create). | `/api/V1/ListTransferRecords` |
| **LookupBill** | The LookupBill entity (create). | `/api/V1/LookupBills` |
| **Product** | The Product entity (list). | `/api/V1/GetProducts` |
| **ProductDescription** | The ProductDescription entity (list). | `/api/V1/GetProductDescriptions` |
| **Promotion** | The Promotion entity (list). | `/api/V1/GetPromotions` |
| **PromotionDescription** | The PromotionDescription entity (list). | `/api/V1/GetPromotionDescriptions` |
| **Provider** | The Provider entity (list). | `/api/V1/GetProviders` |
| **ProviderStatus** | The ProviderStatus entity (list). | `/api/V1/GetProviderStatus` |
| **Region** | The Region entity (list). | `/api/V1/GetRegions` |
| **SendTransfer** | The SendTransfer entity (create). | `/api/V1/SendTransfer` |
...
- Upstream API: [https://api.dingconnect.com](https://api.dingconnect.com)
...
Generated from the Ding API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
