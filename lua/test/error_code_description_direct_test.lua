...
describe("ErrorCodeDescriptionDirect", function()
  it("should direct-list-error_code_description", function()
    local setup = error_code_description_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-error_code_description", setup.live and "live" or "unit")
...
function error_code_description_direct_setup(mockres)
