...
describe("ProductDescriptionDirect", function()
  it("should direct-list-product_description", function()
    local setup = product_description_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-product_description", setup.live and "live" or "unit")
...
function product_description_direct_setup(mockres)
