...
describe("PromotionDescriptionDirect", function()
  it("should direct-list-promotion_description", function()
    local setup = promotion_description_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-promotion_description", setup.live and "live" or "unit")
...
function promotion_description_direct_setup(mockres)
