...
describe("AccountLookupDirect", function()
  it("should direct-list-account_lookup", function()
    local setup = account_lookup_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-account_lookup", setup.live and "live" or "unit")
...
function account_lookup_direct_setup(mockres)
