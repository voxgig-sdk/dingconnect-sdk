...
describe("ProviderStatusDirect", function()
  it("should direct-list-provider_status", function()
    local setup = provider_status_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-provider_status", setup.live and "live" or "unit")
...
function provider_status_direct_setup(mockres)
