...
describe("PromotionDirect", function()
  it("should direct-list-promotion", function()
    local setup = promotion_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-promotion", setup.live and "live" or "unit")
