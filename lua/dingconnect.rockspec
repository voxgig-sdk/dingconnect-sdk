package = "voxgig-sdk-dingconnect"
version = "0.0.1-1"
source = {
  -- git+https (GitHub dropped git:// in 2022); pin the install to the release
  -- tag pushed by `make publish`, and point at the lua/ subdir of the monorepo.
  url = "git+https://github.com/voxgig-sdk/dingconnect-sdk.git",
  tag = "lua/v0.0.1",
...
description = {
  ...
  license = "MIT",
  labels = { "voxgig", "sdk", "generated-sdk", "openapi", "api-client", "dingconnect" }
}
dependencies = {
  "lua >= 5.3",
  "dkjson >= 2.5",
...
build = {
  type = "builtin",
  modules = {
    ["dingconnect_sdk"] = "dingconnect_sdk.lua",
    ["config"] = "config.lua",
