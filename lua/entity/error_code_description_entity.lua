...
local ErrorCodeDescriptionEntity = {}
ErrorCodeDescriptionEntity.__index = ErrorCodeDescriptionEntity


function ErrorCodeDescriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ErrorCodeDescriptionEntity)
  self._name = "error_code_description"
  self._client = client
...
function ErrorCodeDescriptionEntity:get_name()
  return self._name
end


function ErrorCodeDescriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ErrorCodeDescriptionEntity.new(self._client, opts)
end
...
function ErrorCodeDescriptionEntity:mark_deleted()
  self._deleted = true
end


function ErrorCodeDescriptionEntity:deleted()
  return true == self._deleted
end


function ErrorCodeDescriptionEntity:data_set(args)
  if args ~= nil then
...
function ErrorCodeDescriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ErrorCodeDescriptionEntity:match_set(args)
  if args ~= nil then
...
function ErrorCodeDescriptionEntity:match_get()
...
function ErrorCodeDescriptionEntity:stream(action, args, callopts)
...
---@param reqmatch ErrorCodeDescriptionListMatch
---@param ctrl? table
---@return ErrorCodeDescription[]
---@return string? err
function ErrorCodeDescriptionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ErrorCodeDescriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ErrorCodeDescriptionEntity
