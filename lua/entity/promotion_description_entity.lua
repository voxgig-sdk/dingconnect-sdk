...
local PromotionDescriptionEntity = {}
PromotionDescriptionEntity.__index = PromotionDescriptionEntity


function PromotionDescriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PromotionDescriptionEntity)
  self._name = "promotion_description"
  self._client = client
...
function PromotionDescriptionEntity:get_name()
  return self._name
end


function PromotionDescriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PromotionDescriptionEntity.new(self._client, opts)
end
...
function PromotionDescriptionEntity:mark_deleted()
  self._deleted = true
end


function PromotionDescriptionEntity:deleted()
  return true == self._deleted
end


function PromotionDescriptionEntity:data_set(args)
  if args ~= nil then
...
function PromotionDescriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PromotionDescriptionEntity:match_set(args)
  if args ~= nil then
...
function PromotionDescriptionEntity:match_get()
...
function PromotionDescriptionEntity:stream(action, args, callopts)
...
---@param reqmatch PromotionDescriptionListMatch
---@param ctrl? table
---@return PromotionDescription[]
---@return string? err
function PromotionDescriptionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PromotionDescriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PromotionDescriptionEntity
