...
local CancelResultEntity = {}
CancelResultEntity.__index = CancelResultEntity


function CancelResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CancelResultEntity)
  self._name = "cancel_result"
  self._client = client
...
function CancelResultEntity:get_name()
  return self._name
end


function CancelResultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CancelResultEntity.new(self._client, opts)
end


function CancelResultEntity:data_set(args)
  if args ~= nil then
...
function CancelResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CancelResultEntity:match_set(args)
  if args ~= nil then
...
function CancelResultEntity:match_get()
...
function CancelResultEntity:stream(action, args, callopts)
...
---@param reqdata CancelResultCreateData
---@param ctrl? table
---@return CancelResult
---@return string? err
function CancelResultEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CancelResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
