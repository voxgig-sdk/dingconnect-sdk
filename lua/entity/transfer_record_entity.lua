...
local TransferRecordEntity = {}
TransferRecordEntity.__index = TransferRecordEntity


function TransferRecordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransferRecordEntity)
  self._name = "transfer_record"
  self._client = client
...
function TransferRecordEntity:get_name()
  return self._name
end


function TransferRecordEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TransferRecordEntity.new(self._client, opts)
end


function TransferRecordEntity:data_set(args)
  if args ~= nil then
...
function TransferRecordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransferRecordEntity:match_set(args)
  if args ~= nil then
...
function TransferRecordEntity:match_get()
...
function TransferRecordEntity:stream(action, args, callopts)
...
---@param reqdata TransferRecordCreateData
---@param ctrl? table
---@return TransferRecord
---@return string? err
function TransferRecordEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransferRecordEntity:_run_op(ctx, post_done)
  local utility = self._utility
