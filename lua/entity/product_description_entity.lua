...
local ProductDescriptionEntity = {}
ProductDescriptionEntity.__index = ProductDescriptionEntity


function ProductDescriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProductDescriptionEntity)
  self._name = "product_description"
  self._client = client
...
function ProductDescriptionEntity:get_name()
  return self._name
end


function ProductDescriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProductDescriptionEntity.new(self._client, opts)
end
...
function ProductDescriptionEntity:mark_deleted()
  self._deleted = true
end


function ProductDescriptionEntity:deleted()
  return true == self._deleted
end


function ProductDescriptionEntity:data_set(args)
  if args ~= nil then
...
function ProductDescriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProductDescriptionEntity:match_set(args)
  if args ~= nil then
...
function ProductDescriptionEntity:match_get()
...
function ProductDescriptionEntity:stream(action, args, callopts)
...
---@param reqmatch ProductDescriptionListMatch
---@param ctrl? table
---@return ProductDescription[]
---@return string? err
function ProductDescriptionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ProductDescriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
