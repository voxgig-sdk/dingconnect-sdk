...
local ProviderStatusEntity = {}
ProviderStatusEntity.__index = ProviderStatusEntity


function ProviderStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProviderStatusEntity)
  self._name = "provider_status"
  self._client = client
...
function ProviderStatusEntity:get_name()
  return self._name
end


function ProviderStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProviderStatusEntity.new(self._client, opts)
end
...
function ProviderStatusEntity:mark_deleted()
  self._deleted = true
end


function ProviderStatusEntity:deleted()
  return true == self._deleted
end


function ProviderStatusEntity:data_set(args)
  if args ~= nil then
...
function ProviderStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProviderStatusEntity:match_set(args)
  if args ~= nil then
...
function ProviderStatusEntity:match_get()
...
function ProviderStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ProviderStatusListMatch
---@param ctrl? table
---@return ProviderStatus[]
---@return string? err
function ProviderStatusEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ProviderStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
