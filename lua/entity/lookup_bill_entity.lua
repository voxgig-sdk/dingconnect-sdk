...
local LookupBillEntity = {}
LookupBillEntity.__index = LookupBillEntity


function LookupBillEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LookupBillEntity)
  self._name = "lookup_bill"
  self._client = client
...
function LookupBillEntity:get_name()
  return self._name
end


function LookupBillEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LookupBillEntity.new(self._client, opts)
end
...
function LookupBillEntity:mark_deleted()
  self._deleted = true
end


function LookupBillEntity:deleted()
  return true == self._deleted
end


function LookupBillEntity:data_set(args)
  if args ~= nil then
...
function LookupBillEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LookupBillEntity:match_set(args)
  if args ~= nil then
...
function LookupBillEntity:match_get()
...
function LookupBillEntity:stream(action, args, callopts)
...
---@param reqdata LookupBillCreateData
---@param ctrl? table
---@return LookupBill
---@return string? err
function LookupBillEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function LookupBillEntity:_run_op(ctx, post_done)
  local utility = self._utility
