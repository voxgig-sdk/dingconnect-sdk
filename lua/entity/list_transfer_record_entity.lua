...
local ListTransferRecordEntity = {}
ListTransferRecordEntity.__index = ListTransferRecordEntity


function ListTransferRecordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListTransferRecordEntity)
  self._name = "list_transfer_record"
  self._client = client
...
function ListTransferRecordEntity:get_name()
  return self._name
end


function ListTransferRecordEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListTransferRecordEntity.new(self._client, opts)
end
...
function ListTransferRecordEntity:mark_deleted()
  self._deleted = true
end


function ListTransferRecordEntity:deleted()
  return true == self._deleted
end


function ListTransferRecordEntity:data_set(args)
  if args ~= nil then
...
function ListTransferRecordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListTransferRecordEntity:match_set(args)
  if args ~= nil then
...
function ListTransferRecordEntity:match_get()
...
function ListTransferRecordEntity:stream(action, args, callopts)
...
---@param reqdata ListTransferRecordCreateData
---@param ctrl? table
---@return ListTransferRecord
---@return string? err
function ListTransferRecordEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ListTransferRecordEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ListTransferRecordEntity
