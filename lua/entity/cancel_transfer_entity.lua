...
local CancelTransferEntity = {}
CancelTransferEntity.__index = CancelTransferEntity


function CancelTransferEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CancelTransferEntity)
  self._name = "cancel_transfer"
  self._client = client
...
function CancelTransferEntity:get_name()
  return self._name
end


function CancelTransferEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CancelTransferEntity.new(self._client, opts)
end
...
function CancelTransferEntity:mark_deleted()
  self._deleted = true
end


function CancelTransferEntity:deleted()
  return true == self._deleted
end


function CancelTransferEntity:data_set(args)
  if args ~= nil then
...
function CancelTransferEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CancelTransferEntity:match_set(args)
  if args ~= nil then
...
function CancelTransferEntity:match_get()
...
function CancelTransferEntity:stream(action, args, callopts)
...
---@param reqdata CancelTransferCreateData
---@param ctrl? table
---@return CancelTransfer
---@return string? err
function CancelTransferEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CancelTransferEntity:_run_op(ctx, post_done)
  local utility = self._utility
