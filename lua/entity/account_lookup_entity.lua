...
local AccountLookupEntity = {}
AccountLookupEntity.__index = AccountLookupEntity


function AccountLookupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountLookupEntity)
  self._name = "account_lookup"
  self._client = client
...
function AccountLookupEntity:get_name()
  return self._name
end


function AccountLookupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AccountLookupEntity.new(self._client, opts)
end
...
function AccountLookupEntity:mark_deleted()
  self._deleted = true
end


function AccountLookupEntity:deleted()
  return true == self._deleted
end


function AccountLookupEntity:data_set(args)
  if args ~= nil then
...
function AccountLookupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountLookupEntity:match_set(args)
  if args ~= nil then
...
function AccountLookupEntity:match_get()
...
function AccountLookupEntity:stream(action, args, callopts)
...
---@param reqmatch AccountLookupListMatch
---@param ctrl? table
---@return AccountLookup[]
---@return string? err
function AccountLookupEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AccountLookupEntity:_run_op(ctx, post_done)
  local utility = self._utility
