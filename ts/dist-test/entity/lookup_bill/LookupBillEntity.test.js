...
(0, node_test_1.describe)('LookupBillEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'lookup_bill.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/lookup_bill/LookupBillTestData.json');
    ...
    let idmap = transform(['lookup_bill01', 'lookup_bill02', 'lookup_bill03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DINGCONNECT_TEST_LOOKUP_BILL_ENTID'];
...
//# sourceMappingURL=LookupBillEntity.test.js.map