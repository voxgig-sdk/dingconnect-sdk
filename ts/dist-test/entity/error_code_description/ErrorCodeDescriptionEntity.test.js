...
(0, node_test_1.describe)('ErrorCodeDescriptionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'error_code_description.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/error_code_description/ErrorCodeDescriptionTestData.json');
    ...
    let idmap = transform(['error_code_description01', 'error_code_description02', 'error_code_description03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DINGCONNECT_TEST_ERROR_CODE_DESCRIPTION_ENTID'];
...
//# sourceMappingURL=ErrorCodeDescriptionEntity.test.js.map