...
(0, node_test_1.describe)('ErrorCodeDescriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DingconnectSDK({
    ...
    (0, node_test_1.test)('direct-list-error_code_description', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-error_code_description', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DingconnectSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.DINGCONNECT_APIKEY,
        }));
        let idmap = env['DINGCONNECT_TEST_ERROR_CODE_DESCRIPTION_ENTID'];
    ...
    const client = new __1.DingconnectSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ErrorCodeDescriptionDirect.test.js.map