...
(0, node_test_1.describe)('PromotionDescriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-promotion_description', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-promotion_description', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DINGCONNECT_TEST_PROMOTION_DESCRIPTION_ENTID'];
...
//# sourceMappingURL=PromotionDescriptionDirect.test.js.map