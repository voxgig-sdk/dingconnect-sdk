...
(0, node_test_1.describe)('PromotionDescriptionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'promotion_description.' + op, live))
                return;
        }
        ...
        let promotion_description_ref01_data = Object.values(setup.data.existing.promotion_description)[0];
        // LIST
        const promotion_description_ref01_ent = client.PromotionDescription();
        const promotion_description_ref01_match = {};
        const promotion_description_ref01_list = (await promotion_description_ref01_ent.list(promotion_description_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/promotion_description/PromotionDescriptionTestData.json');
    ...
    let idmap = transform(['promotion_description01', 'promotion_description02', 'promotion_description03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PromotionDescriptionEntity.test.js.map