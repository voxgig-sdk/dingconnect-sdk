...
(0, node_test_1.describe)('AccountLookupEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'account_lookup.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/account_lookup/AccountLookupTestData.json');
    ...
    let idmap = transform(['account_lookup01', 'account_lookup02', 'account_lookup03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DINGCONNECT_TEST_ACCOUNT_LOOKUP_ENTID'];
...
//# sourceMappingURL=AccountLookupEntity.test.js.map