...
(0, node_test_1.describe)('ProductDescriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-product_description', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-product_description', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DINGCONNECT_TEST_PRODUCT_DESCRIPTION_ENTID'];
...
//# sourceMappingURL=ProductDescriptionDirect.test.js.map