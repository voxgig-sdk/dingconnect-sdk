...
(0, node_test_1.describe)('SendTransferEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'send_transfer.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/send_transfer/SendTransferTestData.json');
    ...
    let idmap = transform(['send_transfer01', 'send_transfer02', 'send_transfer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DINGCONNECT_TEST_SEND_TRANSFER_ENTID'];
...
//# sourceMappingURL=SendTransferEntity.test.js.map