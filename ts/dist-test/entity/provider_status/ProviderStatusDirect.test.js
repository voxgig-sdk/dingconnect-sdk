...
(0, node_test_1.describe)('ProviderStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-provider_status', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-provider_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DINGCONNECT_TEST_PROVIDER_STATUS_ENTID'];
...
//# sourceMappingURL=ProviderStatusDirect.test.js.map