...
(0, node_test_1.describe)('ProviderStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'provider_status.' + op, live))
                return;
        }
        ...
        let provider_status_ref01_data = Object.values(setup.data.existing.provider_status)[0];
        // LIST
        const provider_status_ref01_ent = client.ProviderStatus();
        const provider_status_ref01_match = {};
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/provider_status/ProviderStatusTestData.json');
    ...
    let idmap = transform(['provider_status01', 'provider_status02', 'provider_status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DINGCONNECT_TEST_PROVIDER_STATUS_ENTID'];
...
//# sourceMappingURL=ProviderStatusEntity.test.js.map