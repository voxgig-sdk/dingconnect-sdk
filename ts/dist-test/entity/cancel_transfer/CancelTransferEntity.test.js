...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cancel_transfer/CancelTransferTestData.json');
    ...
    let idmap = transform(['cancel_transfer01', 'cancel_transfer02', 'cancel_transfer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CancelTransferEntity.test.js.map