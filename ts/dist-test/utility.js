...
function envOverride(m) {
    if ('TRUE' === process.env.DINGCONNECT_TEST_LIVE ||
        'TRUE' === process.env.DINGCONNECT_TEST_OVERRIDE) {
    ...
    m.DINGCONNECT_TEST_EXPLAIN = process.env.DINGCONNECT_TEST_EXPLAIN || m.DINGCONNECT_TEST_EXPLAIN;
    return m;
}
