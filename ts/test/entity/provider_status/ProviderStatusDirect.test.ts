...
describe('ProviderStatusDirect', async () => {
  ...
  test('direct-list-provider_status', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-provider_status', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['DINGCONNECT_TEST_PROVIDER_STATUS_ENTID']
