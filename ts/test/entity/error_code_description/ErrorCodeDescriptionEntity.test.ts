...
describe('ErrorCodeDescriptionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'error_code_description.' + op, live)) return
    }
    ...
    let error_code_description_ref01_data = Object.values(setup.data.existing.error_code_description)[0] as any
