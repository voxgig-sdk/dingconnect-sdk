...
describe('PromotionDescriptionDirect', async () => {
  ...
  test('direct-list-promotion_description', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-promotion_description', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['DINGCONNECT_TEST_PROMOTION_DESCRIPTION_ENTID']
