...
describe('AccountLookupDirect', async () => {
  ...
  test('direct-list-account_lookup', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-account_lookup', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['DINGCONNECT_TEST_ACCOUNT_LOOKUP_ENTID']
