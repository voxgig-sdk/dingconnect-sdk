...
describe('ProductDescriptionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'product_description.' + op, live)) return
    }
    ...
    let product_description_ref01_data = Object.values(setup.data.existing.product_description)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/product_description/ProductDescriptionTestData.json')
