...
module DingconnectTestRunner
  ...
  def self.env_override(m)
    live = getenv("DINGCONNECT_TEST_LIVE")
    override = getenv("DINGCONNECT_TEST_OVERRIDE")
    ...
    explain = getenv("DINGCONNECT_TEST_EXPLAIN")
    m["DINGCONNECT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DingconnectTestRunner
Helpers = DingconnectHelpers
Vs = VoxgigStruct
