...
class ProviderEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DINGCONNECT_TEST_PROVIDER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def provider_basic_setup(extra)
  ...
  entid_env_raw = ENV["DINGCONNECT_TEST_PROVIDER_ENTID"]
