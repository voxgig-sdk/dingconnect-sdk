...
class RegionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DINGCONNECT_TEST_REGION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def region_basic_setup(extra)
  ...
  entid_env_raw = ENV["DINGCONNECT_TEST_REGION_ENTID"]
