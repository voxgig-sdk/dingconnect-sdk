...
class SendTransferEntity
  ...
  def make
    opts = @_entopts.dup
    SendTransferEntity.new(@_client, opts)
  end
  ...
  # @return [SendTransfer, Hash] the current SendTransfer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SendTransfer fields)
  def match_get
  ...
  #
  # @param reqdata [SendTransferCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SendTransfer, Hash] the created SendTransfer; raises DingconnectError on failure
