...
class ProductDescriptionEntity
  ...
  def make
    opts = @_entopts.dup
    ProductDescriptionEntity.new(@_client, opts)
  end
  ...
  # @return [ProductDescription, Hash] the current ProductDescription data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProductDescription fields)
  def match_get
  ...
  #
  # @param reqmatch [ProductDescriptionListMatch, Hash, nil] match filter (any subset of
  #   ProductDescription fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ProductDescription>, Array] the matching ProductDescription items; raises DingconnectError on failure
