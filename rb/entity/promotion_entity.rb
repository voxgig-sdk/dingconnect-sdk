# Dingconnect SDK Promotion entity
...
class PromotionEntity
  ...
  def make
    opts = @_entopts.dup
    PromotionEntity.new(@_client, opts)
  end
  ...
  # @return [Promotion, Hash] the current Promotion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Promotion fields)
  def match_get
  ...
  # List Promotion items matching the given filter.
  #
  # @param reqmatch [PromotionListMatch, Hash, nil] match filter (any subset of
  #   Promotion fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Promotion>, Array] the matching Promotion items; raises DingconnectError on failure
