...
class TransferRecordEntity
  ...
  def make
    opts = @_entopts.dup
    TransferRecordEntity.new(@_client, opts)
  end
  ...
  # @return [TransferRecord, Hash] the current TransferRecord data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransferRecord fields)
  def match_get
  ...
  #
  # @param reqdata [TransferRecordCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransferRecord, Hash] the created TransferRecord; raises DingconnectError on failure
