...
class EstimateEntity
  ...
  def make
    opts = @_entopts.dup
    EstimateEntity.new(@_client, opts)
  end
  ...
  # @return [Estimate, Hash] the current Estimate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Estimate fields)
  def match_get
  ...
  #
  # @param reqdata [EstimateCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Estimate, Hash] the created Estimate; raises DingconnectError on failure
