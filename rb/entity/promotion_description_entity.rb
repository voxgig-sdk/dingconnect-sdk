...
class PromotionDescriptionEntity
  ...
  def make
    opts = @_entopts.dup
    PromotionDescriptionEntity.new(@_client, opts)
  end
  ...
  # @return [PromotionDescription, Hash] the current PromotionDescription data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PromotionDescription fields)
  def match_get
  ...
  #
  # @param reqmatch [PromotionDescriptionListMatch, Hash, nil] match filter (any subset of
  #   PromotionDescription fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PromotionDescription>, Array] the matching PromotionDescription items; raises DingconnectError on failure
