...
class CancelTransferEntity
  ...
  def make
    opts = @_entopts.dup
    CancelTransferEntity.new(@_client, opts)
  end
  ...
  # @return [CancelTransfer, Hash] the current CancelTransfer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CancelTransfer fields)
  def match_get
  ...
  #
  # @param reqdata [CancelTransferCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CancelTransfer, Hash] the created CancelTransfer; raises DingconnectError on failure
