...
class CancelResultEntity
  ...
  def make
    opts = @_entopts.dup
    CancelResultEntity.new(@_client, opts)
  end
  ...
  # @return [CancelResult, Hash] the current CancelResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CancelResult fields)
  def match_get
  ...
  #
  # @param reqdata [CancelResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CancelResult, Hash] the created CancelResult; raises DingconnectError on failure
