...
class LookupBillEntity
  ...
  def make
    opts = @_entopts.dup
    LookupBillEntity.new(@_client, opts)
  end
  ...
  # @return [LookupBill, Hash] the current LookupBill data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LookupBill fields)
  def match_get
  ...
  #
  # @param reqdata [LookupBillCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [LookupBill, Hash] the created LookupBill; raises DingconnectError on failure
