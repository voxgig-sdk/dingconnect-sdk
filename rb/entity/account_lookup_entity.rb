...
class AccountLookupEntity
  ...
  def make
    opts = @_entopts.dup
    AccountLookupEntity.new(@_client, opts)
  end
  ...
  # @return [AccountLookup, Hash] the current AccountLookup data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountLookup fields)
  def match_get
  ...
  #
  # @param reqmatch [AccountLookupListMatch, Hash, nil] match filter (any subset of
  #   AccountLookup fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AccountLookup>, Array] the matching AccountLookup items; raises DingconnectError on failure
