...
class ProviderStatusEntity
  ...
  def make
    opts = @_entopts.dup
    ProviderStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ProviderStatus, Hash] the current ProviderStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ProviderStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ProviderStatusListMatch, Hash, nil] match filter (any subset of
  #   ProviderStatus fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ProviderStatus>, Array] the matching ProviderStatus items; raises DingconnectError on failure
