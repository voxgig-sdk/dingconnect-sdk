...
class EstimatePriceEntity
  ...
  def make
    opts = @_entopts.dup
    EstimatePriceEntity.new(@_client, opts)
  end
  ...
  # @return [EstimatePrice, Hash] the current EstimatePrice data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EstimatePrice fields)
  def match_get
  ...
  #
  # @param reqdata [EstimatePriceCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [EstimatePrice, Hash] the created EstimatePrice; raises DingconnectError on failure
