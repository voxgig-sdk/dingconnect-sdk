...
class ProviderStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProviderStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ProviderStatus:
    ...
    def match_get(self) -> ProviderStatus:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ProviderStatus]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ProviderStatus().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
