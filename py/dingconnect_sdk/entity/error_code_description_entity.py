...
from dingconnect_sdk.dingconnect_types import (
...
class ErrorCodeDescriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ErrorCodeDescriptionEntity(self._client, opts)
    ...
    def data_get(self) -> ErrorCodeDescription:
    ...
    def match_get(self) -> ErrorCodeDescription:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ErrorCodeDescription]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ErrorCodeDescription().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
