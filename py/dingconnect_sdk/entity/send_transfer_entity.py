...
class SendTransferEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SendTransferEntity(self._client, opts)
    ...
    def data_get(self) -> SendTransfer:
    ...
    def match_get(self) -> SendTransfer:
    ...
    def create(self, reqdata: SendTransferCreateData, ctrl=None) -> SendTransfer:
        utility = self._utility
