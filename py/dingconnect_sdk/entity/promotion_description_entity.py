...
class PromotionDescriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PromotionDescriptionEntity(self._client, opts)
    ...
    def data_get(self) -> PromotionDescription:
    ...
    def match_get(self) -> PromotionDescription:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PromotionDescription]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PromotionDescription().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
