...
class EstimatePriceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EstimatePriceEntity(self._client, opts)
    ...
    def data_get(self) -> EstimatePrice:
    ...
    def match_get(self) -> EstimatePrice:
    ...
    def create(self, reqdata: EstimatePriceCreateData, ctrl=None) -> EstimatePrice:
        utility = self._utility
