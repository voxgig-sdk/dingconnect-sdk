...
class ProductDescriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ProductDescriptionEntity(self._client, opts)
    ...
    def data_get(self) -> ProductDescription:
    ...
    def match_get(self) -> ProductDescription:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ProductDescription]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ProductDescription().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
