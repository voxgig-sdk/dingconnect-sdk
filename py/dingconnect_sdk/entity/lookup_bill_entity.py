...
class LookupBillEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LookupBillEntity(self._client, opts)
    ...
    def create(self, reqdata: LookupBillCreateData, ctrl=None) -> LookupBill:
        utility = self._utility
