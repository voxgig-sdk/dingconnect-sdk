...
class ListTransferRecordEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListTransferRecordEntity(self._client, opts)
    ...
    def data_get(self) -> ListTransferRecord:
    ...
    def match_get(self) -> ListTransferRecord:
    ...
    def create(self, reqdata: ListTransferRecordCreateData, ctrl=None) -> ListTransferRecord:
        utility = self._utility
