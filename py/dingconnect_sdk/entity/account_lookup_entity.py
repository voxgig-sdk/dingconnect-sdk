...
class AccountLookupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountLookupEntity(self._client, opts)
    ...
    def data_get(self) -> AccountLookup:
    ...
    def match_get(self) -> AccountLookup:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AccountLookup]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AccountLookup().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
