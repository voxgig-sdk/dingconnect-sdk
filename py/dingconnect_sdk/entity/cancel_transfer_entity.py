...
class CancelTransferEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CancelTransferEntity(self._client, opts)
    ...
    def data_get(self) -> CancelTransfer:
    ...
    def match_get(self) -> CancelTransfer:
    ...
    def create(self, reqdata: CancelTransferCreateData, ctrl=None) -> CancelTransfer:
        utility = self._utility
