# Dingconnect SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DingconnectSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DingconnectSDK(...) and DingconnectSDK.test(...) become
#      DingconnectSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dingconnect_sdk"
_SDK_CLASS = "DingconnectSDK"
