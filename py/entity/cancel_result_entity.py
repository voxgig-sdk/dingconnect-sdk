...
class CancelResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CancelResultEntity(self._client, opts)
    ...
    def data_get(self) -> CancelResult:
    ...
    def match_get(self) -> CancelResult:
    ...
    def create(self, reqdata: CancelResultCreateData, ctrl=None) -> CancelResult:
        utility = self._utility
