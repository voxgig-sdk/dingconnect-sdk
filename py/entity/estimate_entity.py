...
class EstimateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EstimateEntity(self._client, opts)
    ...
    def create(self, reqdata: EstimateCreateData, ctrl=None) -> Estimate:
        utility = self._utility
