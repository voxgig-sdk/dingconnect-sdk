...
class TransferRecordEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransferRecordEntity(self._client, opts)
    ...
    def data_get(self) -> TransferRecord:
    ...
    def match_get(self) -> TransferRecord:
    ...
    def create(self, reqdata: TransferRecordCreateData, ctrl=None) -> TransferRecord:
        utility = self._utility
