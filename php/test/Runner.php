...
class DingconnectTestRunner
{
    ...
    {
        $live = self::getenv('DINGCONNECT_TEST_LIVE');
        $override = self::getenv('DINGCONNECT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DINGCONNECT_TEST_EXPLAIN');
...
class_alias('DingconnectTestRunner', 'Runner');
class_alias('DingconnectHelpers', 'Helpers');
