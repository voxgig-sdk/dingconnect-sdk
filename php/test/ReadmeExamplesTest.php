...
// Dingconnect SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DingconnectSDK::test)
...
{
    private const SDK_CLASS = 'DingconnectSDK';
    ...
    private const SDK_BASE = 'dingconnect_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dingconnect_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
