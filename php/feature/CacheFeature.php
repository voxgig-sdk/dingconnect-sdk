...
class DingconnectCacheFeature extends DingconnectBaseFeature
{
    ...
    private function _through(DingconnectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
