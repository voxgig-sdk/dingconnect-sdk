...
// Dingconnect SDK netsim feature
...
class DingconnectNetsimFeature extends DingconnectBaseFeature
{
    ...
    private function _simulate(DingconnectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DingconnectContext $ctx, array $applied): void
    {
        $client = $this->client;
