...
// Dingconnect SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DingconnectTestFeature extends DingconnectBaseFeature
{
    ...
    public function init(DingconnectContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DingconnectContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DingconnectParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DingconnectContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DingconnectContext $ctx, $op, $args): array
    {
