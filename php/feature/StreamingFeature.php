...
// Dingconnect SDK streaming feature
...
class DingconnectStreamingFeature extends DingconnectBaseFeature
{
    ...
    private function _iterate(DingconnectResult $result): \Generator
    {
    ...
    private function _streamable(DingconnectContext $ctx): bool
    {
