...
// Dingconnect SDK ratelimit feature
...
class DingconnectRatelimitFeature extends DingconnectBaseFeature
{
    ...
    private function _acquire(DingconnectContext $ctx): void
    {
    ...
    private function _track(DingconnectContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
