...
class DingconnectClienttrackFeature extends DingconnectBaseFeature
{
    ...
    public function PostConstruct(DingconnectContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dingconnect-SDK';
