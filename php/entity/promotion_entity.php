...
class PromotionEntity
{
     ...
     *
     * @param PromotionListMatch|array|null $reqmatch Match filter (any subset
     *   of Promotion fields) as an assoc-array; PromotionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Promotion[]|array A list of Promotion items as assoc-arrays at
