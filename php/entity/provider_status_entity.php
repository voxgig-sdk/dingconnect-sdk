...
// Dingconnect SDK ProviderStatus entity
...
class ProviderStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProviderStatusEntity($this->_client, $opts);
    }

    /**
     * @param ProviderStatus|array $args ProviderStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ProviderStatus|array The current ProviderStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProviderStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProviderStatus fields).
     */
    ...
    /**
     * List ProviderStatus items matching the given filter.
     *
     * @param ProviderStatusListMatch|array|null $reqmatch Match filter (any subset
     *   of ProviderStatus fields) as an assoc-array; ProviderStatusListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProviderStatus[]|array A list of ProviderStatus items as assoc-arrays at
