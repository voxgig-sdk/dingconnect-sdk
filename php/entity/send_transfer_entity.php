...
// Dingconnect SDK SendTransfer entity
...
class SendTransferEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SendTransferEntity($this->_client, $opts);
    }

    /**
     * @param SendTransfer|array $args SendTransfer data (assoc-array) to store.
     */
    ...
    /**
     * @return SendTransfer|array The current SendTransfer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SendTransfer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SendTransfer fields).
     */
    ...
    /**
     * Create a new SendTransfer.
     *
     * @param SendTransferCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SendTransferCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SendTransfer|array The created SendTransfer as an assoc-array at the
