...
// Dingconnect SDK EstimatePrice entity
...
class EstimatePriceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EstimatePriceEntity($this->_client, $opts);
    }

    /**
     * @param EstimatePrice|array $args EstimatePrice data (assoc-array) to store.
     */
    ...
    /**
     * @return EstimatePrice|array The current EstimatePrice data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EstimatePrice fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EstimatePrice fields).
     */
    ...
    /**
     * Create a new EstimatePrice.
     *
     * @param EstimatePriceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EstimatePriceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EstimatePrice|array The created EstimatePrice as an assoc-array at the
