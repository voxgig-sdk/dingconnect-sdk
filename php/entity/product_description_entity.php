...
// Dingconnect SDK ProductDescription entity
...
class ProductDescriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "product_description";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ProductDescriptionEntity($this->_client, $opts);
    }

    /**
     * @param ProductDescription|array $args ProductDescription data (assoc-array) to store.
     */
    ...
    /**
     * @return ProductDescription|array The current ProductDescription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProductDescription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProductDescription fields).
     */
    ...
    /**
     * List ProductDescription items matching the given filter.
     *
     * @param ProductDescriptionListMatch|array|null $reqmatch Match filter (any subset
     *   of ProductDescription fields) as an assoc-array; ProductDescriptionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductDescription[]|array A list of ProductDescription items as assoc-arrays at
