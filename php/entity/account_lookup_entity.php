...
// Dingconnect SDK AccountLookup entity
...
class AccountLookupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AccountLookupEntity($this->_client, $opts);
    }

    /**
     * @param AccountLookup|array $args AccountLookup data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountLookup|array The current AccountLookup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountLookup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountLookup fields).
     */
    ...
    /**
     * List AccountLookup items matching the given filter.
     *
     * @param AccountLookupListMatch|array|null $reqmatch Match filter (any subset
     *   of AccountLookup fields) as an assoc-array; AccountLookupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountLookup[]|array A list of AccountLookup items as assoc-arrays at
