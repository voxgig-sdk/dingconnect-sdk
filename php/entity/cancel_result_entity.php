...
// Dingconnect SDK CancelResult entity
...
class CancelResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CancelResultEntity($this->_client, $opts);
    }

    /**
     * @param CancelResult|array $args CancelResult data (assoc-array) to store.
     */
    ...
    /**
     * @return CancelResult|array The current CancelResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CancelResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CancelResult fields).
     */
    ...
    /**
     * Create a new CancelResult.
     *
     * @param CancelResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CancelResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CancelResult|array The created CancelResult as an assoc-array at the
