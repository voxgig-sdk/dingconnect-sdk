...
// Dingconnect SDK LookupBill entity
...
class LookupBillEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LookupBillEntity($this->_client, $opts);
    }

    /**
     * @param LookupBill|array $args LookupBill data (assoc-array) to store.
     */
    ...
    /**
     * @return LookupBill|array The current LookupBill data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LookupBill fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LookupBill fields).
     */
    ...
    /**
     * Create a new LookupBill.
     *
     * @param LookupBillCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LookupBillCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LookupBill|array The created LookupBill as an assoc-array at the
