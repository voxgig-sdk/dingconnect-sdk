...
// Dingconnect SDK Estimate entity
...
class EstimateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EstimateEntity($this->_client, $opts);
    }

    /**
     * @param Estimate|array $args Estimate data (assoc-array) to store.
     */
    ...
    /**
     * @return Estimate|array The current Estimate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Estimate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Estimate fields).
     */
     ...
     *
     * @param EstimateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EstimateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Estimate|array The created Estimate as an assoc-array at the
