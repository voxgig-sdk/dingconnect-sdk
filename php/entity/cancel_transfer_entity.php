...
// Dingconnect SDK CancelTransfer entity
...
class CancelTransferEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CancelTransferEntity($this->_client, $opts);
    }

    /**
     * @param CancelTransfer|array $args CancelTransfer data (assoc-array) to store.
     */
    ...
    /**
     * @return CancelTransfer|array The current CancelTransfer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CancelTransfer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CancelTransfer fields).
     */
    ...
    /**
     * Create a new CancelTransfer.
     *
     * @param CancelTransferCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CancelTransferCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CancelTransfer|array The created CancelTransfer as an assoc-array at the
