...
// Dingconnect SDK ListTransferRecord entity
...
class ListTransferRecordEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "list_transfer_record";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ListTransferRecordEntity($this->_client, $opts);
    }

    /**
     * @param ListTransferRecord|array $args ListTransferRecord data (assoc-array) to store.
     */
    ...
    /**
     * @return ListTransferRecord|array The current ListTransferRecord data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListTransferRecord fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListTransferRecord fields).
     */
    ...
    /**
     * Create a new ListTransferRecord.
     *
     * @param ListTransferRecordCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ListTransferRecordCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListTransferRecord|array The created ListTransferRecord as an assoc-array at the
     *   SDK boundary; throws DingconnectError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                if ($ctx->result->resdata) {
                    $this->_data = DingconnectHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
