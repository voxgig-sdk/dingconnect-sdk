...
// Dingconnect SDK TransferRecord entity
...
class TransferRecordEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransferRecordEntity($this->_client, $opts);
    }

    /**
     * @param TransferRecord|array $args TransferRecord data (assoc-array) to store.
     */
    ...
    /**
     * @return TransferRecord|array The current TransferRecord data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransferRecord fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransferRecord fields).
     */
     ...
     *
     * @param TransferRecordCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransferRecordCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransferRecord|array The created TransferRecord as an assoc-array at the
