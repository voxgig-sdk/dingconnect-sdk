...
// Dingconnect SDK PromotionDescription entity
...
class PromotionDescriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "promotion_description";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PromotionDescriptionEntity($this->_client, $opts);
    }

    /**
     * @param PromotionDescription|array $args PromotionDescription data (assoc-array) to store.
     */
    ...
    /**
     * @return PromotionDescription|array The current PromotionDescription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PromotionDescription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PromotionDescription fields).
     */
    ...
    /**
     * List PromotionDescription items matching the given filter.
     *
     * @param PromotionDescriptionListMatch|array|null $reqmatch Match filter (any subset
     *   of PromotionDescription fields) as an assoc-array; PromotionDescriptionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PromotionDescription[]|array A list of PromotionDescription items as assoc-arrays at
