...
class DingconnectProxyFeature extends DingconnectBaseFeature
{
    ...
    public function init(DingconnectContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DingconnectContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
