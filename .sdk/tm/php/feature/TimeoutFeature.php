...
// Dingconnect SDK timeout feature
...
class DingconnectTimeoutFeature extends DingconnectBaseFeature
{
    ...
    private function _with_timeout(DingconnectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DingconnectContext $_ctx, float $ms): void
    {
        $client = $this->client;
