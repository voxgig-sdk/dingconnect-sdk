...
class DingconnectRbacFeature extends DingconnectBaseFeature
{
    ...
    private function _required(DingconnectContext $ctx): ?string
    {
    ...
    private function _reject(DingconnectContext $ctx, string $required): void
    {
    ...
    private function _track(DingconnectContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
