...
// Dingconnect SDK paging feature
...
class DingconnectPagingFeature extends DingconnectBaseFeature
{
    ...
    private function _graphql_pre_request(DingconnectContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(DingconnectContext $ctx): bool
    {
