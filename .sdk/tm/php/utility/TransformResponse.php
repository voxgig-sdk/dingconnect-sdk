...
// Dingconnect SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DingconnectTransformResponse
{
    public static function call(DingconnectContext $ctx): mixed
    {
        ...
        $transform = DingconnectHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
