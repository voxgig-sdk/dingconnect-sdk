...
// Dingconnect SDK utility: graphql
//
...
class DingconnectGraphql
{
    ...
    // equivalent.
    public static function body(DingconnectContext $ctx): mixed
    {
    ...
    public static function errors(DingconnectContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
