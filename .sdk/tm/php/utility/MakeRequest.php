...
// Dingconnect SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DingconnectMakeRequest
{
    public static function call(DingconnectContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DingconnectResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DingconnectResponse($fetched);
        } else {
