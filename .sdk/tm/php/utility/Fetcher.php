...
// Dingconnect SDK utility: fetcher

class DingconnectFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DingconnectSDK/1.0)';
    ...
    public static function call(DingconnectContext $ctx, string $fullurl, array $fetchdef): array
    {
