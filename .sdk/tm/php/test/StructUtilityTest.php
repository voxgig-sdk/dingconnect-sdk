...
// Dingconnect SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DingconnectOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DingconnectOmni::structfix($now, Struct::undef()))
                        !== json_encode(DingconnectOmni::structfix($val, Struct::undef()))) {
