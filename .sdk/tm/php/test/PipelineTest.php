...
{
    private static function utility(): DingconnectUtility
    {
        return new DingconnectUtility();
    }
    ...
    private static function ctx(array $over = []): DingconnectContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DingconnectContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DingconnectOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DingconnectError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DingconnectOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DingconnectMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DingconnectOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DingconnectMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DingconnectOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DingconnectMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DingconnectSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DingconnectMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DingconnectResponse([]),
            'result' => new DingconnectResult([]),
        ]);
        [, $err] = DingconnectMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DingconnectSpec([]),
            'response' => null,
            'result' => new DingconnectResult([]),
        ]);
        [, $err] = DingconnectMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DingconnectSpec(['step' => 's']),
            'response' => new DingconnectResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DingconnectResult([]),
        ]);
        [, $err] = DingconnectMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DingconnectSpec(['step' => 's']),
            'response' => new DingconnectResponse(self::resp(200, ['v' => 1])),
            'result' => new DingconnectResult([]),
        ]);
        [, $err] = DingconnectMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DingconnectSpec(['step' => 's']),
            'response' => new DingconnectResponse(self::resp(200, ['v' => 2])),
            'result' => new DingconnectResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DingconnectMakeResponse::call($ctx);
    ...
    {
        $preset = new DingconnectResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DingconnectSpec([]),
            'response' => new DingconnectResponse([]),
            'result' => new DingconnectResult([]),
        ...
        [$got, $err] = DingconnectMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DingconnectResult([])]);
        [, $err] = DingconnectMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DingconnectSpec([]), 'result' => null]);
        [, $err] = DingconnectMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DingconnectSpec(['step' => 's']),
            'result' => new DingconnectResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DingconnectOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DingconnectMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DingconnectSpec(['step' => 's']),
            'result' => new DingconnectResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DingconnectOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DingconnectMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DingconnectResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DingconnectSpec([]),
            'result' => new DingconnectResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DingconnectMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DingconnectMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DingconnectError('boom', 'boom');
        $utility->fetcher = function (DingconnectContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DingconnectSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DingconnectMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DingconnectContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DingconnectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DingconnectResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DingconnectMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DingconnectContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DingconnectSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DingconnectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DingconnectResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DingconnectSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DingconnectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DingconnectMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DingconnectMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DingconnectResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DingconnectDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DingconnectResult(['ok' => false])]);
        $this->expectException(DingconnectError::class);
        DingconnectDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DingconnectResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DingconnectMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DingconnectMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DingconnectBaseFeature();
        $b = new DingconnectBaseFeature();
        DingconnectFeatureAdd::call($ctx, $a);
        DingconnectFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DingconnectBaseFeature
    {
        $f = new DingconnectBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DingconnectFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DingconnectContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DingconnectSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DingconnectPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DingconnectPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DingconnectResponse(['headers' => null]),
            'result' => new DingconnectResult([]),
        ]);
        DingconnectResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        DingconnectResultBody::call($ctx);
