...
class DingconnectContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DingconnectSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DingconnectResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DingconnectResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DingconnectError(code, msg, self)
