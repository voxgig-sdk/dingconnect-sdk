...
|---|---|---|
| `ts/` | @voxgig-sdk/dingconnect | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dingconnect \
      --repository voxgig-sdk/dingconnect-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dingconnect` shows it, and
`npm trust revoke @voxgig-sdk/dingconnect --id=<id>` removes it.
